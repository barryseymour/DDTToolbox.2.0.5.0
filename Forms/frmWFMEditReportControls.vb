Public Class frmWFMEditReportControls
    Private currentControlID As Integer

	Private Sub frmWFMEditReportControls_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
		Me.Icon = frmMain.Icon ' Barry
		Me.CancelButton = btnCancel
	End Sub

    Private Sub FillDataFields()
        For Each dRow As DataRow In frmWFMTree.dsroot.Tables("trControls").Rows
            If dRow.Item("ControlsID") = cboControlsID.SelectedValue Then
                txtControlTitle.Text = dRow.Item("ControlTitle").ToString
                For Each cRow As DataRow In frmWFMTree.dsroot.Tables("trControls_Master").Rows
    ...
    Private Sub frmWFMEditReportControls_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
    End Sub
