Public Class frmInsertDARTTngTreeItem
    ...
    Private Sub frmInsertDARTTngTreeItem_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		Me.Icon = frmMain.Icon ' Barry

		rdoPasteItemFromClipboard.Enabled = Not frmDARTTngTree.CopyNode Is Nothing
        rdoPasteItemFromClipboard.Checked = rdoPasteItemFromClipboard.Enabled

        Dim selectedItemIsFolder As Boolean = (Strings.Left(frmDARTTngTree.InsertType, 6).ToUpper = "FOLDER")
        Dim folderInsertNotAllowed As Boolean = (frmDARTTngTree.InsertType.ToUpper = "FOLDER-NO INSERT")
